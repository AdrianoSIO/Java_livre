 ...
 * @author  Alice Clochard
 * @version 1 (26 novembre 2025)
 */
   ...
   * @throws Exception Exception levée si il y a une erreur (base non trouvée par exemple)
   */
public Db_mariadb(String p_db_name, String login, String password) throws Exception{
   ...
   * @throws Exception       Exception levée si il y a une erreur (base non trouvée, erreur SQL)
   */
